...
int main(int argc, char *argv[])
{
  ...
  // std::cout << "Percursso em pré-ordem:\t" << arvore_vp.percPreOrdem() <<
  // std::endl; std::cout << "Percursso em pós-ordem:\t" <<
  // arvore_vp.percPosOrdem() << std::endl; std::cout << "Sucessor de 5:\t" <<
  // arvore_vp.sucessor(5) << std::endl; std::cout << "Predecessor de 13:\t" <<
  // arvore_vp.predecessor(13) << std::endl;
  arvore_vp.remover(7);
